...
public class ModCreativeModeTabs {
    public static CreativeModeTab COOL_TAB;

    @SubscribeEvent
    public static void registerCreativeModeTabs(CreativeModeTabEvent.Register event) {
        COOL_TAB = event.registerCreativeModeTab(new ResourceLocation(CoolMod.MOD_ID, "cool_tab"),
                builder -> builder.icon(() -> new ItemStack(ModItems.BLACK_OPAL.get()))
                        .title(Component.translatable("creativemodetab.cool_tab")));
    }
}
